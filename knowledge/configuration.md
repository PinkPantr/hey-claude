...
| `output_sink` | output device for spoken replies. Empty = default. **Linux only** — ignored on macOS (`afplay`) and Windows (`winsound`), which use the system default output. |
